-- ============================================================================
-- Zroyecto Pombie - ajustes de jugabilidad (sandbox)
-- ============================================================================
-- FUENTE DE VERDAD. Se copia al contenedor en cada arranque hacia
-- Zomboid/Server/<nombre>_SandboxVars.lua
--
-- Punto de partida: los valores por defecto de la 42.20 instalada
-- (ver config/reference/SandboxVars.lua, que NO se edita).
--
-- OJO: muchos de estos valores solo tienen efecto al CREAR el mundo. Los que
-- se aplican en caliente lo hacen al reiniciar. En la fase 2 iremos ajustando
-- esto por bloques, dejando en el commit el porque de cada valor.
-- ============================================================================
